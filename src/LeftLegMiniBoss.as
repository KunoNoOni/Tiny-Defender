package
{
	...
	public class LeftLegMiniBoss extends FlxSprite
	{
		...
		public function LeftLegMiniBoss(X:Number=0, Y:Number=0)
		{
			super(X*16,Y*16);
			loadGraphic(Registry.llmb,false,false,16,16);
		...
		override public function update():void
		{
			...
			if(Registry.area2MiniBoss && y < 10)
			{
				velocity.y = 50;
			}
