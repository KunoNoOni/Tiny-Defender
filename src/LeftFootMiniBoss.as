package
{
	...
	public class LeftFootMiniBoss extends FlxSprite
	{
		...
		public function LeftFootMiniBoss(X:Number=0, Y:Number=0)
		{
			super(X*16,Y*16);
			loadGraphic(Registry.lfmb,false,false,16,16);
		...
		override public function update():void
		{
			...
			if(Registry.area1MiniBoss && y < 10)
			{
				velocity.y = 50;
			}
