package
{
	...
	public class RightFootMiniBoss extends FlxSprite
	{
		...
		public function RightFootMiniBoss(X:Number=0, Y:Number=0)
		{
			super(X*16,Y*16);
			loadGraphic(Registry.rfmb,false,false,16,16);
		...
		override public function update():void
		{
			...
			if(Registry.area4MiniBoss && y < 10)
			{
				velocity.y = 50;
			}
