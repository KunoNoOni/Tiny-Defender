package
{
	...
	public class LeftArmMiniBoss extends FlxSprite
	{
		...
		public function LeftArmMiniBoss(X:Number=0, Y:Number=0)
		{
			super(X*16,Y*16);
			loadGraphic(Registry.lamb,false,false,16,16);
		...
		override public function update():void
		{
			...
			if(Registry.area6MiniBoss && y < 10)
			{
				velocity.y = 50;
			}
